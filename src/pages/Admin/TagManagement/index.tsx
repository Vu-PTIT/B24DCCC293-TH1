...
import { Button, Card, Input, message, Typography, Modal } from 'antd';
import { PlusOutlined } from '@ant-design/icons';
import { MOCK_TAGS, MOCK_POSTS } from '@/services/blog/mock';
import { Tag, Post, DeveloperRole } from '@/services/blog/typings';
...
const TagManagement: React.FC = () => {
  ...
  const totalUsedTags = useMemo(() => tagsWithCount.filter(tag => tag.postCount > 0).length, [tagsWithCount]);
  ...
  return (
    <div style={{ padding: 24, minHeight: '100%', background: '#f5f7fb' }}>
      <Card bodyStyle={{ padding: 24, borderRadius: 16 }} style={{ borderRadius: 16 }}>
        ...
        >
          <div>
            ...
            <div style={{ color: '#6c7a93', marginTop: 8, maxWidth: 520 }}>
              Danh sách thẻ với tên và số bài viết đang sử dụng. Thẻ có thể được thêm, sửa hoặc xóa.
            </div>
          </div>
        ...
        <div style={{ marginTop: 24, textAlign: 'right', color: '#999', fontSize: '12px' }}>
